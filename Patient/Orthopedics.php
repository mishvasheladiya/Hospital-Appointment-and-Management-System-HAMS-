...
<head>
    ...
    <title>Orthopedics Doctor List</title>
...
<body>
    ...
    <div class="header-section">
        <h1>Orthopedics Doctor List</h1>
        <p>Find expert orthopedists for all your bone, joint, and muscle concerns and treatments.</p>
    </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="doctor-card card">
                    <img src="../image/a.jpg" alt="Doctor Image">
                    <div class="card-body">
                        <h5 class="card-title">Dr. Rajdeep Raiyani</h5>
                        <p class="card-text">Orthopedic Surgeon, MBBS, MS - Orthopedics</p>
                    ...
                    <div id="doctor1-details" class="collapse collapse-details">
                        ...
                        <p><strong>Specialties:</strong> Joint replacement, Sports injuries, Spine surgery</p>
                        <p><strong>Contact:</strong> rajdeep@medical.com</p>
